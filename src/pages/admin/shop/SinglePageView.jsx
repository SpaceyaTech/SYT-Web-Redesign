        ...
        <div className="grid items-center">
          ...
          <Link to="/">
            <div className="flex items-center space-x-[8px]">
              ...
              <span className="font-[500] text-[13px]">BACK</span>
            </div>
          </Link>
          {/* Stock Status */}
          ...
          <div className="grid items-center pt-[31px]">
            <div className="text-[16px] font-[400] text-[#353535]">
              Available Sizes
            </div>
        ...
        <div className="grid w-full border-[1px] border-[#D0D0D0] rounded-[12px] overflow-auto font-poppins">
          ...
          <div className="font-[600] px-[12px] text-[16px] text-[#4C4D4D] h-[48px] flex justify-between items-center">
            ...
            <div className="cursor-pointer">
              <button
                type="button"
                className="flex items-center rounded-[6px] text-[14px] font-[500] py-[9px] px-[17px] gap-[8px] border-[1px] border-[#D1D5DB]"
              >
                <span>Filter</span>
                <span>
                  ...
                  <tbody>
                    {innerData.map((e) => (
                      ...
                      >
                        ...
                        <td className="h-[52px] px-6">{e.size}</td>
                        ...
                        <td className="h-[52px] px-6 text-right space-x-[16px] pr-[12px] text-nowrap">
                          ...
                          <span className="text-[#7E8180] cursor-pointer">
                            Remove
                          </span>
                        </td>
                      </tr>
...
function SmallPhoto({ url = smallImageOne }) {
  return (
