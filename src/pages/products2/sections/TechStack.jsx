...
const TechStack = () => {
  return (
    <section className="px-4 md:px-8 py-6 md:py-12 flex flex-col md:justify-between md:flex-row gap-5 md:gap-6">
      <h2 className="font-medium md:text-3xl lg:text-5xl text-2xl leading-[38px] md:leading-[64px] lg:leading-[48px] md:max-w-[430px]">
