...
function Services() {
  return (
    <section className="text-gray-600 body-font flex items-center bg-[#F7F7F7]">
      <div className="hidden md:flex w-full md:w-1/2 justify-center items-center py-20">
        <img
      ...
      <div className="flex flex-col flex-wrap bg-[#00664E] lg:py-6 md:w-1/2 lg:pl-12 lg:text-left text-center">
