...
const events = [
  ...
  {
    img: techrecruiters,
    title: "Insights and Advice from Tech Recruiters ",
    date: "Sat, May 6, 2023 8:00 PM EAT",
    location: "Twitter Spaces",
    mode: "virtual",
    id: 4,
  ...
  return (
    <div className="w-screen flex flex-col ">
      ...
      <div className="px-20">
        ...
        <p className="text-l text-[#323433] font-normal mb-6">When and Where</p>
        <div className="flex flex-row justify-between">
          <div className="flex flex-row">
            <div className="mr-8">
              ...
              <div className="text-sm text-[#323433] font-light mb-6 ml-8">
                <p>Saturday May 6th, 2023</p>
                <p>14:30PM - 5:30PM EAT</p>
              </div>
            </div>
            <div>
              <div>
        ...
        <div>
          ...
          <p className="text-sm text-[#323433] font-light mb-6">
            Microsoft PowerBI is one of the most popular Business Intelligence
            and Big Data tools in the market today. Most companies use PowerBI
            to build dashboards that allow them to visualise data essential to
            operations/management and draw insights from them.
          </p>

          <p className="text-sm text-[#323433] font-light mb-6">
            In this masterclass, you'll learn how to conduct data analysis and
            data visualisation with PowerBI. You'll work hands-on on building
            PowerBI dashboards as you learn from data experts from KPMG, EY, and
            Zindua School. At the end of the workshop, you'll have a take-home
            project and additional resources to get you to practice and
            reinforce skills learned during the workshop.
          </p>

          <p className="text-sm text-[#323433] font-light mb-6">
            ATTENDEES WILL BE ISSUED A CERTIFICATE ON COMPLETION OF THE
            TAKE-HOME POWER BI PROJECT. THIS SHOULD A DEDICATED WEEKEND OR A
            WEEK OR TWO FOR THOSE WORKING.
          </p>

          <p className="text-sm text-[#323433] font-light mb-6">
            Note that this is a paid masterclass and you'll be required to
            confirm your slot after registering a ticket here. Payment details
            will be on the email received on registration. Here are the prices:
          </p>
          <ol className="list-decimal text-sm text-[#323433] font-light mb-2 pl-8">
            <li>Early-Bird Tickets (Phase I): Ksh 1000/=</li>
            <li>Discounted Tickets (Phase II): Ksh 1500/=</li>
            <li>Regular Tickets (Phase III): Ksh 2000/=</li>
        ...
        <div className="pb-6">
          ...
          <p className="text-xl text-[#323433] font-light">Similar Events</p>
