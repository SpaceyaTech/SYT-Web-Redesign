...
function JoinSYTForm({ closeModal }) {
  ...
  function handleClick() {
    closeModal();
    window.open("https://discord.com/invite/xSH9eAgBJm", "_blank");
  }
      ...
      <div className="flex flex-col w-full gap-8">
        ...
        {!showInvite ? (
          <form
            ...
            className={`flex flex-col gap-5 transition-all duration-100 ease-in-out transform `}
          >
            <label
              htmlFor="fullname"
            ...
            {err && (
              <p className="text-center text-red-500 italic font-normal">
                {err}
              </p>
            )}
          </form>
