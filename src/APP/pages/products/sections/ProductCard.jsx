...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-10 p-6 border-2 border-gray-900 rounded-2xl">
      ...
      <button className="py-3 px-8 border-2 border-solid border-[#009975] rounded-lg flex items-center justify-center text-sm text-[#009975] capitalize transition-all duration-300 ease-in hover:text-white hover:bg-[#009975]">
        {button}
      </button>
    </div>
  );
