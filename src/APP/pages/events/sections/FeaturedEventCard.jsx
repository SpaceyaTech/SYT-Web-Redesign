...
function FeaturedEventCard() {
  return (
    <div className="w-full border bg-white p-2 rounded-2xl">
      <div
        className="w-full h-[512px] rounded-xl overflow-clip"
        style={{
          backgroundImage: `url(${startinevEvent})`,
        }}
      >
        <div className="size-full p-6 pb-28 flex flex-col items-center justify-end text-white bg-gradient-to-b from-transparent via-green-dark/20 to-green-dark">
          <div className="flex-center flex-col gap-4 max-w-xl w-full">
            <h4 className="text-3xl font-semibold text-center">
              The StartupBar Freelancers Edition
            </h4>

            <p className="text-center text-base font-normal">
              Learn how you can bridge the gap between academia and industry as
              a freelancer
            </p>
            ...
            <div className="w-2/3 grid grid-cols-2 gap-x-4 gap-y-2 lg:gap-x-16 lg:gap-y-6">
              ...
              <div className="flex items-center gap-2 lg:place-self-end">
                ...
                <span className="text-base font-normal">1700HRS</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-base line-clamp-1 font-normal">
                  Amka Cafe, Westlands
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 lg:place-self-end">
                ...
                <span className="text-base text-nowrap font-normal">
                  Development
                </span>
              </div>
            </div>
