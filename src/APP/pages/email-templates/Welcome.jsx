...
function Welcome() {
  return (
    <main className="bg-[#F4FFFC]">
      <section className="bg-white max-w-[1048px] mx-auto border border-red-500 flex items-center flex-col gap-8 px-2 md:px-0 py-12">
        <img src={logo} alt="logo" className="h-16 w-16 object-contain" />

        <img src={wave} alt="wave" className="w-40 h-40 object-cover" />
        <div className="flex flex-col items-start gap-6 border max-w-xl">
          ...
          <p className="text-base font-normal">
            ...
            give back by mentoring others. Let's build a supportive tech family
            together!"
            <br />
            <br />
        ...
        <div className="flex items-center justify-between border w-full max-w-xl">
