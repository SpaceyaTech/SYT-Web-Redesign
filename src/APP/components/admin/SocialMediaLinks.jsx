    ...
    <div className="w-3/4 mt-4 items-center">
      ...
      <p className="tracking-wider text-lg font-normal text-[#323433]">
        ...
        <div className={`w-full mt-4 ${errors.website ? '' : 'h-10'}`}>
          <input
            id="website"
            {...register("website", { required: "Website link required.", pattern: { value: /^(ftp|http|https):\/\/[^ "]+$/, message: "Enter a valid URL." } })}
        ...
        <div className={`w-full mt-4 ${errors.facebook ? '' : 'h-10'}`}>
          <input
            id="facebook"
            {...register("facebook", { required: "Facebook link Required.", pattern: { value: /^(ftp|http|https):\/\/[^ "]+$/, message: "Enter a valid URL." } })}
            className="w-full h-12 px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300"
            type="text"
        ...
        <div className={`w-full mt-4 ${errors.twitter ? '' : 'h-10'}`}>
          <input
            id="twitter"
            {...register("twitter", { required: "Twitter link Required.", pattern: { value: /^(ftp|http|https):\/\/[^ "]+$/, message: "Enter a valid URL." } })}
            className="w-full h-12 px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300"
            type="text"
            placeholder="Twitter"
          />
        ...
        <div className={`w-full mt-4 ${errors.linkedin ? '' : 'h-10'}`}>
          <input
            id="linkedin"
            {...register("linkedin", { required: "Linkedin link Required.", pattern: { value: /^(ftp|http|https):\/\/[^ "]+$/, message: "Enter a valid URL." } })}
            className="w-full h-12 px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300"
            type="text"
        ...
        <div className={`w-full mt-4 ${errors.instagram ? '' : 'h-10'}`}>
          <input
            id="instagram"
            {...register("instagram", { required: "Instagram link Required.", pattern: { value: /^(ftp|http|https):\/\/[^ "]+$/, message: "Enter a valid URL." } })}
            className="w-full h-12 px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300"
            type="text"
